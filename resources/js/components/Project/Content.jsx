...
const Content = ({ project }) => {
    return (
        <div className="mx-auto max-w-screen-lg px-5 py-10 md:py-16">
            <p className="mb-1 text-lg text-l-accent dark:text-d-accent md:text-2xl">
                Project Web Development
            </p>
            <h1 className="font-lora text-4xl font-bold text-l-primary dark:text-d-primary md:text-6xl">
                {project.title}
            </h1>
            ...
            <div className="mt-7 flex flex-col justify-between gap-5 md:mt-12 md:flex-row">
                <div className="space-y-4 md:space-y-7">
                    <div className="space-y-1 md:space-y-2">
                        <h3 className="text-base font-bold text-l-primary dark:text-d-primary md:text-lg">
                            Title
                        </h3>
                        <h4 className="text-base text-l-secondary dark:text-d-secondary md:text-lg">
                            {project.title}
                        </h4>
                    </div>
                    <div className="space-y-1 md:space-y-2">
                    ...
                    <div className="pt-2 md:pt-0">
                        ...
                        >
                            <button
                                type="button"
                                className="inline-flex h-fit w-full items-center justify-center gap-0.5 rounded-full bg-l-accent px-4 py-2.5 text-sm text-white hover:bg-l-accent hover:bg-l-accent/90 dark:bg-d-accent dark:bg-d-accent/90 dark:hover:bg-d-accent md:px-5 md:py-2.5 md:text-lg"
                            >
                                Visit Website{" "}
